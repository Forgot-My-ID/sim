...
def MM1(maximum_number_of_customers, mean_arrival_time, mean_service_time):
    ...
    for i in range(number_of_process):
        ...
        total_customers_in_queue += queue
    ...
    average_customers_in_queue = total_customers_in_queue / time
    print("Average Number of Customers in Queue: ", round(average_customers_in_queue, 2))
    ...
    plt.title('MM1 Queueing Simulation')
    plt.show()
